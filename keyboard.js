...
(function() {
    ...
    this.VKI_isIE = /*@cc_on!@*/
    false;
    this.VKI_isIE6 = /*@if(@_jscript_version == 5.6)!@end@*/
    false;
    this.VKI_isIElt8 = /*@if(@_jscript_version < 5.8)!@end@*/
    false;
        ...
        for (var x = 0, hasDeadKey = false, lyt; lyt = this.VKI_layout[this.VKI_kt].keys[x++];) {
            ...
            for (var y = 0, lkey; lkey = lyt[y++];) {
                ...
                if (this.VKI_symbol[lkey[0]]) {
                    ...
                    td.appendChild(document.createTextNode(lkey[0] || "\xa0"));
                ...
                default:
                    if (type) {
                        ...
                        if (this.VKI_symbol[lkey[vchar]]) {
                            ...
                            tds[y].appendChild(document.createTextNode(lkey[vchar] || "\xa0"));
                    }
                    if (this.VKI_deadkeysOn.checked) {
    ...
    var allowedChars = new Array("q", "w", "e",
    "r", "t", "y", "u", "i", "o", "p",
    "a", "s", "d", "f", "g", "h", "j", "k", "l",
